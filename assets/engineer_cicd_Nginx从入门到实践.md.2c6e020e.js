...
<span class="line"><span style="color:#E1E4E8;">   </span><span style="color:#F97583;"> index </span><span style="color:#E1E4E8;">index.html;</span></span>
<span class="line"><span style="color:#E1E4E8;">}</span></span></code></pre></div><p>然后重启 nginx，我们就可以在浏览器中访问 <code>http://localhost:8001</code>了。</p><h3 id="缓存配置" tabindex="-1">缓存配置 <a class="header-anchor" href="#缓存配置" aria-label="Permalink to &quot;缓存配置&quot;">​</a></h3><p>缓存对于 Web 至关重要，尤其对于大型高负载 Web 站点。Nginx 缓存可作为性能优化的一个重要手段，可以极大减轻后端服务器的负载。通常对于静态资源，即较少经常更新的资源，如图片，css 或 js 等进行缓存，从而在每次刷新浏览器的时候，不用重新请求，而是从缓存里面读取，这样就可以减轻服务器的压力。</p><p>Nginx 缓存类型：</p><p><img src="`+o+`" alt=""></p><p>Nginx 设置缓存有两种方式：</p><ul><li><code>proxy_cache_path</code> 和 <code>proxy_cache</code></li><li><code>Cache-Control</code> 和 <code>Pragma</code></li></ul><p><strong>一般来说，由服务器设置缓存即可，nginx 代理缓存可以不设置。</strong></p><blockquote><p>参考：<a href="https://www.cnblogs.com/itzgr/p/13321980.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/itzgr/p/13321980.html</a></p></blockquote><h3 id="跨域配置" tabindex="-1">跨域配置 <a class="header-anchor" href="#跨域配置" aria-label="Permalink to &quot;跨域配置&quot;">​</a></h3><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">script</span><span style="color:#E1E4E8;">&gt;</span></span>
