import{_ as n,o as a,c as l,S as p}from"./chunks/framework.d5a27ec8.js";const u=JSON.parse('{"title":"配置路由 vue-router","description":"","frontmatter":{},"headers":[],"relativePath":"engineer/vue3-template/vue-router.md","filePath":"engineer/vue3-template/vue-router.md","lastUpdated":1689052576000}'),o={name:"engineer/vue3-template/vue-router.md"};function e(t,s,E,c,r,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="配置路由-vue-router" tabindex="-1">配置路由 vue-router <a class="header-anchor" href="#配置路由-vue-router" aria-label="Permalink to &quot;配置路由 vue-router&quot;">​</a></h1><h2 id="配置步骤" tabindex="-1">配置步骤 <a class="header-anchor" href="#配置步骤" aria-label="Permalink to &quot;配置步骤&quot;">​</a></h2><p>1、安装插件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark"><code><span class="line"><span style="color:#e1e4e8;">npm install vue-router@next</span></span></code></pre></div><p>2、在 router/index.ts 中配置路由</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#E1E4E8;">};</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> route;</span></span></code></pre></div>`,37)]))}const F=n(o,[["render",e]]);export{u as __pageData,F as default};
