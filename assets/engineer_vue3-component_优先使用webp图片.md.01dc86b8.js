import{_ as n,o as a,c as p,S as l}from"./chunks/framework.d5a27ec8.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"engineer/vue3-component/优先使用webp图片.md","filePath":"engineer/vue3-component/优先使用webp图片.md","lastUpdated":1715332685000}'),e={name:"engineer/vue3-component/优先使用webp图片.md"};function o(t,s,c,i,r,E){return a(),p("div",null,s[0]||(s[0]=[l(`<p>在vue2中有一个mixin.js文件，用来混入enum枚举和const常量，以及图片到所有的组件中。避免每次在组件中使用，需要import导入。</p><p>在此基础上增加一些代码，如果图片的文件名相同，则优先使用webp格式的图片。</p><p>代码如下：</p><div class="language-diff"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#E1E4E8;">import * as configConst from &quot;@/config/const&quot;;</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#E1E4E8;">Vue.</span><span style="color:#B392F0;">mixin</span><span style="color:#E1E4E8;">(mixin);</span></span></code></pre></div>`,6)]))}const u=n(e,[["render",o]]);export{y as __pageData,u as default};
